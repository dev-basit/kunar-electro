...
export default function Form() {
  ...
  } = useForm<InterfaceSignin>({ defaultValues: { email: "", password: "" } });

  useEffect(() => {
    if (session && session.user) router.push(callbackUrl);
  }, [callbackUrl, params, router, session]);

  const formSubmit: SubmitHandler<InterfaceSignin> = async (form) => {
          ...
          <div className="my-2">
            ...
            <input
              ...
              {...register("email", {
                ...
                pattern: { value: /[a-z0-9]+@[a-z]+\.[a-z]{2,3}/, message: "Email is invalid" },
              })}
